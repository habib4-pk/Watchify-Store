        ...
        <div class="product-grid">
            ...
            <article class="product-card" data-watch-id="{{ $watch->id }}">
                <div class="image-container">
                    <img src="{{ asset('photos/' . $watch->image) }}" 
                         class="product-image" 
                         alt="{{ $watch->name }}"
                ...
                <div class="product-info">
                    ...
                    <div class="button-group">
                        ...
                        @else
                            <button class="btn-add btn-disabled" disabled title="This item is currently out of stock">
                                Out of Stock
                            </button>
                        @endif
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Handle authentication check for add to cart
    const addToCartForms = document.querySelectorAll('.add-to-cart-form');
    addToCartForms.forEach(form => {
        form.addEventListener('submit', function(e) {
            // Check if user is authenticated (you can add your own check here)
